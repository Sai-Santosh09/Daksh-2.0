...
class AppLocalizationsTe extends AppLocalizations {
  ...
  String get partsOfSpeechDescription =>
      'నామవాచకాలు, క్రియలు, విశేషణాలు మరియు మరిన్ని గురించి తెలుసుకోండి.';
  ...
  String get sentenceStructureDescription =>
      'వాక్య నిర్మాణం మరియు వ్యాకరణ నియమాలను నేర్చుకోండి.';
  ...
  String get tensesDescription =>
      'భూత, వర్తమాన మరియు భవిష్యత్ కాలాలను అర్థం చేసుకోండి.';
  ...
  String get punctuationDescription =>
      'సరైన విరామ చిహ్నాల వాడకాన్ని నేర్చుకోండి.';
  ...
  String daysAgo(int count) {
    ...
    String _temp0 = intl.Intl.pluralLogic(
      count,
      locale: localeName,
      other: '$countString రోజులు క్రితం',
      one: '1 రోజు క్రితం',
      zero: 'ఈరోజు',
    );
    return '$_temp0';
  ...
  String get quickPracticeDescription =>
      'రోజువారీ అభ్యాసానికి చిన్న వ్యాయామాలు';
  ...
  String get focusedPracticeDescription =>
      'నిర్దిష్ట వ్యాకరణ ప్రాంతాలను లక్ష్యంగా చేసుకోండి';
  ...
  String get challengeModeDescription =>
      'కష్టమైన వ్యాయామాలతో మీ నైపుణ్యాలను పరీక్షించండి';
  ...
  String get testYourKnowledge =>
      'మీ వ్యాకరణ జ్ఞానాన్ని పరీక్షించండి మరియు సమగ్ర మూల్యాంకనలతో మీ పురోగతిని ట్రాక్ చేయండి.';
  ...
  String get quickAssessmentDescription =>
      '5-10 నిమిషాలు • ప్రాథమిక వ్యాకరణ జ్ఞానం';
  ...
  String get comprehensiveTestDescription =>
      '30-45 నిమిషాలు • పూర్తి వ్యాకరణ మూల్యాంకనం';
  ...
  String get skillSpecificTestDescription =>
      '15-20 నిమిషాలు • నిర్దిష్ట ప్రాంతాలపై దృష్టి పెట్టండి';
  ...
  String get saveMobileData =>
      'Wi-Fi మాత్రమే డౌన్‌లోడ్ చేసి మొబైల్ డేటాను ఆదా చేయండి';

  @override
  String get autoDownloadNewContent =>
      'కొత్త కంటెంట్‌ను స్వయంచాలకంగా డౌన్‌లోడ్ చేయండి';

  @override
  String get automaticallyDownloadNewLessons =>
      'అందుబాటులో ఉన్నప్పుడు కొత్త పాఠాలను స్వయంచాలకంగా డౌన్‌లోడ్ చేయండి';
  ...
  String get getHelpAndContactSupport =>
      'సహాయం పొందండి మరియు మద్దతుతో సంప్రదించండి';
