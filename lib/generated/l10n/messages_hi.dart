...
class messages_hi extends messages {
  ...
  static messages_hi? _current;

  static messages_hi get messages {
    _current ??= messages_hi();
    return _current!;
  }
  ...
  @override
  String get partsOfSpeechDescription => 'संज्ञा, क्रिया, विशेषण और अन्य के बारे में जानें।';

  @override
  String get sentenceStructure => 'वाक्य संरचना';

  @override
  String get sentenceStructureDescription => 'वाक्य निर्माण और व्याकरण नियमों में महारत हासिल करें।';
  ...
  @override
  String get focusedPracticeDescription => 'विशिष्ट व्याकरण क्षेत्रों को लक्षित करें';

  @override
  String get challengeMode => 'चुनौती मोड';

  @override
  String get challengeModeDescription => 'कठिन अभ्यासों के साथ अपने कौशल का परीक्षण करें';
  ...
  @override
  String get testYourKnowledge => 'अपने व्याकरण ज्ञान का परीक्षण करें और व्यापक मूल्यांकन के साथ अपनी प्रगति को ट्रैक करें।';
  ...
  @override
  String get comprehensiveTestDescription => '30-45 मिनट • पूर्ण व्याकरण मूल्यांकन';

  @override
  String get skillSpecificTest => 'कौशल-विशिष्ट परीक्षण';

  @override
  String get skillSpecificTestDescription => '15-20 मिनट • विशिष्ट क्षेत्रों पर ध्यान केंद्रित करें';
  ...
  @override
  String get autoDownloadNewContent => 'नई सामग्री को स्वचालित रूप से डाउनलोड करें';

  @override
  String get automaticallyDownloadNewLessons => 'उपलब्ध होने पर नए पाठों को स्वचालित रूप से डाउनलोड करें';
  ...
  @override
  String get getHelpAndContactSupport => 'सहायता प्राप्त करें और समर्थन से संपर्क करें';
